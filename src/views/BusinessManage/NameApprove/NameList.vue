<template>
    <div class="secondPageContent">
        <form class="listOne">
            ...
            <el-row :gutter="20">
                <el-col :span="6.5">
                    <div class="grid-content bg-purple">手机号码<input type="text" name="phone" v-model="phone"
                            autocomplete="off"></div>
                </el-col>
                <el-col :span="6.5">
                    <div class="grid-content bg-purple">真实姓名<input type="text" name="realName" v-model="realName"
                            autocomplete="off"></div>
                </el-col>
                <el-col :span="11">
            ...
            <el-row :gutter="20">
                <el-col :span="6.5">
                    <div class="grid-content bg-purple">用户编号<input type="text" name="sequence" v-model="sequence"
                            autocomplete="off"></div>
                </el-col>
                <el-col :span="6.5">
                    <div class="grid-content bg-purple">实名状态<select v-model="authentication"
